...
$.extend($.jgrid,{
	defaults : {
	    ...
	    emptyrecords: "Nenhum registo para visualizar",
		loadtext: "Carregando...",
	...
	del : {
    caption: "Apagar",
	    msg: "Apagar registos seleccionado(s)?",
	    bSubmit: "Apagar",
	    bCancel: "Cancelar"
	},
	nav : {
		edittext: " ",
	    edittitle: "Alterar registo seleccionado",
		addtext:" ",
	    addtitle: "Incluir novo registo",
	    deltext: " ",
	    deltitle: "Apagar registo seleccionado",
	    searchtext: " ",
	    searchtitle: "Procurar registos",
	    refreshtext: "",
	...
	errors : {
		...
		norecords: "Sem registos para exibir",
